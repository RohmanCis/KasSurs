...
3. `.agents/3-DESIGN.md` — **V2.2 Neo-Brutalism**: token warna flat `neo.*`, hard shadow, Bricolage Grotesque, resep komponen 5.1–5.10 (5.10 = alur Speed-Tap + mitigasi salah-tap FINAL), motion, aksesibilitas. Ground truth visual: `.agents/kassurs_ui_neobrutalism_final.html`.

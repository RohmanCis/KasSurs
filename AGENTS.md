...
- **Next:** T-38–T-39 Deployment (Vercel env vars + `prisma migrate deploy` + `prisma db seed`). Utang verifikasi LUNAS: vitest **161/161** (29 files, 2026-09-04) + E2E 10/10 (2026-09-04). Kandidat #2 useApiData NO-GO (ROI eval 2026-09-03 — lihat HANDOFF.md); kandidat arsitektur deepening #1–#4 semua selesai/ditutup. Plan lengkap: HANDOFF.md §4.

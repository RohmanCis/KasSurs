            ...
            <li key={tab.href} className="flex-1">
              <Link
                ...
                className={cn(
                  ...
                  "mx-0.5 flex min-h-[44px] flex-col items-center justify-center gap-0.5 rounded-lg px-1 py-1 text-[10px] neo-press neo-press-sm select-none focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black",
                  aktif
